...
public class CollinearTest
{
 ...
 // ----------------------------------------------------------
    /**
     * Check that the binary search is finding an expected number . 
     */
    @Test
   
    public void testBinarySearchTermPresent() 
    { 
    		int[] a = { 5, 10, 15 }; 
    		boolean expectedResult = true; 
    		assertEquals( "binarySearch(a, 5)", expectedResult,Collinear.binarySearch(a,5));
    		assertEquals( "binarySearch(a, 15)", expectedResult,Collinear.binarySearch(a,15));
    }
 // ----------------------------------------------------------
    /**
     * Check that the binary search is returning false when the number isn't in the array. 
     */
    @Test
    
    public void testBinarySearchNotTermPresent() 
    { 
    		int[] a = { 5, 10, 15 }; 
    		boolean expectedResult = false; 
    		assertEquals( "binarySearch(a, 6)", expectedResult,Collinear.binarySearch(a,6));
    		assertEquals( "binarySearch(a, 16)", expectedResult,Collinear.binarySearch(a,16));
    }
